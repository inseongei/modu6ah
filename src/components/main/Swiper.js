...
const Swiper = () => {
  return (
    <Item>
      ...
      <div className="title animate__animated animate__fadeInDown animate__slow">'육아', 함께 그리고 즐겁게!</div>
      <div className="subtitle animate__animated animate__fadeInUp animate__slow">
      ‘공동육아’란 부모 등 다양한 이웃이 모여 체험, 놀이, 학습 등 활동을 함께 하고 육아 정보<br/>를 공유하는 새로운 보육 공동체입니다. 양육자와 아이 모두 사회 구성원으로 성장할 수<br/> 있도록 서로 도와가며 모두를 위한 육아의 장을 만들어나가요!
      </div>
      </div>
